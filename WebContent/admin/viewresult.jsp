...
<%String bidps=(String)request.getParameter("bids");
System.out.println("Batch ID in JSP Page:"+bidps);%>
<HTML>
<HEAD>
<script>
function validate()
...
<table width="99%"  border="0" align="center" cellpadding="0" cellspacing="0" class="border">
  <tr>
    ...
    <th bgcolor="#6076B0" scope="col"><div align="left"></div></th>
  </tr>
  <tr>
    <th scope="col">&nbsp;</th>
  ...
  <tr>
    ...
    <th width="99%" scope="col"><div align="center">
      <table width="75%"  border="0" align="center" cellpadding="0" cellspacing="0" class="border">
		...
		String table="";
		System.out.println("IIIIIIIIIIIIIIIIIIIIIIIIIIIIII"+bidps);
