...
public void doPost(HttpServletRequest req, HttpServletResponse res)throws ServletException, IOException
	...
	PrintWriter pw = res.getWriter();
		...
		if(modifycheck.equals("Modify"))
		{
				...
				String qry = " update customer set CUST_NAME= '"+CUST_NAME+"',CUST_ADDR1='"+CUST_ADDRESS+"',CUST_CITY='"+CUST_CITY+"',CUST_STATE='"+CUST_STATE+"',CUST_COUNTRY='"+CUST_COUNTRY+"',CUST_FAX='"+CUST_FAX1+"',CUST_DOB='"+CUST_DOB+"',CUST_MAIL='"+CUST_MAIL+"',CUST_SEX='"+SEX+"',CUST_RESNO='"+CUST_RESNO+"',CUST_OFFNO='"+CUST_OFFNO+"',CUST_MOBILE='"+CUST_MOBILE+"',CUST_ADD2='"+CUST_ADD2+"' where CUST_ID='"+cust_id+"'";
				...
				if(i>0)
				{
						...
						res.sendRedirect("/OnlineTest/admin/customerTotal.jsp");
		...
		else if(modifycheck.equalsIgnoreCase("delete"))
		{
			System.out.println("This is delete");
				...
				String qp="delete from login where user_type='user' and login_id='"+cust_id+"'"; 			
