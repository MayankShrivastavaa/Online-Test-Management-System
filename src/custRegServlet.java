...
public class custRegServlet extends HttpServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (i != 0 && j != 0) {
			// String d="You Have successfully Registered.<BR>Login
			// Id="+login+"<BR> and Password="+pwd+"<br><a
			// href=/estudy/login.jsp>login here</a><BR>We Recomend you to
			// Change password";
